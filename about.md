...
-->
<p>I am a Senior Deep Learning Computer Architec at NVIDIA. I optimize GPU architecture and kernel design to improve the performance of various deep learning applications, which involves in-depth performance analysis. Before I joined NVIDIA, I worked for SK hynix as a HW engineer, where I made a major contribution to many projects on phase change memory design and memory system performance optimization. I received my Ph.D. in Electrical and Computer Engineering from the University of Texas at Austin, where I worked with <a href="https://lph.ece.utexas.edu/merez/MattanErez/MattanErez" style="text-decoration : none;color: #cc0000"> professor Mattan Erez</a>. My desseration covers SW, HW, and algorithm co-design for performance-efficient deep nerual network model training. 
</p>
