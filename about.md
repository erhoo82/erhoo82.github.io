...
<ul> 
    ...
    <li>
    <div style="float: left"><b>NVIDIA Research, <i>Research Intern</i></b></div>
    <div style="float: right">2017.05 - 2017.08</div>
    <br>Deep learning workload analysis, GPU memory system architecture
    </li><br>

    <li>
    <div style="float: left"><b>HPE Labs, <i>Research Intern</i></b ></div>
...
<ul> 
    ...
    <li>
    <div style="float: left"><b>SK hynix, <i>PCRAM architecture & circuit design engineer</i></b></div>
